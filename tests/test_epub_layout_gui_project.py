...
class EpubLayoutGuiProjectTests(unittest.TestCase):
    ...
    def test_save_project_writes_series_project_payload(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.filedialog.asksaveasfilename", return_value="/tmp/series-project.json"):
            app.save_project()
    ...
    def test_save_project_records_active_volume_number(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.filedialog.asksaveasfilename", return_value="/tmp/active-series-project.json"):
            app.save_project()
    ...
    def test_open_project_loads_series_project_and_refreshes_workspace(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.filedialog.askopenfilename", return_value=str(payload_path)), \
            patch("manga_pdf_to_epub.epub_layout_gui.SeriesProject.from_payload", return_value=loaded_project) as from_payload:
            app.open_project()
    ...
    def test_validate_series_updates_warnings_and_status(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.messagebox.showwarning"):
            app.validate_series()
    ...
    def test_validate_series_shows_warning_summary_dialog(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.messagebox.showwarning") as showwarning:
            app.validate_series()
