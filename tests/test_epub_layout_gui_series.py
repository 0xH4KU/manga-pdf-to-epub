...
class EpubLayoutGuiSeriesTests(unittest.TestCase):
    def test_import_series_reveals_series_navigation(self):
        ...
        with patch(
            "manga_pdf_to_epub.epub_layout_gui.filedialog.askopenfilenames",
    ...
    def test_export_ready_series_uses_series_project(self):
        ...
        with patch("manga_pdf_to_epub.epub_layout_gui.filedialog.askdirectory", return_value="/tmp/out"):
